...
export default function Example() {
  ...
  return (
    <header className=" bg-black absolute top-0 left-0 right-0 z-50">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            ...
            >
              <div className="p-4">
                {products.map((item) => (
                  <div
                    key={item.name}
                    className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm hover:bg-gray-50 transition-all ease-in-out transform hover:scale-105"
                  >
          ...
          <a href="#" className="text-sm font-semibold text-white hover:text-[#953ee2]">
            Features
          </a>
          <a href="#" className="text-sm font-semibold text-white hover:text-[#953ee2]">
            Marketplace
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold text-gray-100 hover:bg-[#953ee2] ">
                    Product
