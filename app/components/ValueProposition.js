    ...
    <section className="py-16 px-8 bg-gradient-to-r from-purple-100 to-white">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="space-y-6 animate-on-scroll opacity-0 transform -translate-x-10">
          <h2 className="text-3xl font-medium text-gray-800">What Sets RC Tech Solutions Apart?</h2>
          <p className="text-xl font-regular text-gray-600">We don’t just build websites; we create powerful digital solutions that help your brand thrive in a competitive world.</p>
          <ul className="space-y-4 list-none">
            <li className="flex items-center text-lg font-light text-gray-700">
            ...
            <li className="flex items-center font-light text-lg text-gray-700">
              <svg className="w-5 h-5 text-purple-600 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              </svg>
